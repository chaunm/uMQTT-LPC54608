...
- pin_list:
  ...
  - {pin_num: B13, peripheral: FLEXCOMM0, signal: RXD_SDA_MOSI, pin_signal: PIO0_29/FC0_RXD_SDA_MOSI/CTIMER2_MAT3/SCT0_OUT8/TRACEDATA(2), mode: inactive, invert: disabled,
    glitch_filter: disabled, slew_rate: standard, open_drain: disabled}
  - {pin_num: E9, peripheral: EMC, signal: 'EMC_D, 0', pin_signal: PIO0_2/FC3_TXD_SCL_MISO/CTIMER0_CAP1/SCT0_OUT0/SCT0_GPI2/EMC_D(0), identifier: EMC_D0, mode: inactive,
    invert: disabled, glitch_filter: disabled, slew_rate: fast, open_drain: disabled}
  - {pin_num: A10, peripheral: EMC, signal: 'EMC_D, 1', pin_signal: PIO0_3/FC3_RXD_SDA_MOSI/CTIMER0_MAT1/SCT0_OUT1/SCT0_GPI3/EMC_D(1), identifier: EMC_D1, mode: inactive,
    invert: disabled, glitch_filter: disabled, slew_rate: fast, open_drain: disabled}
  - {pin_num: C8, peripheral: EMC, signal: 'EMC_D, 2', pin_signal: PIO0_4/CAN0_RD/FC4_SCK/CTIMER3_CAP0/SCT0_GPI4/EMC_D(2)/ENET_MDC, identifier: EMC_D2, mode: inactive,
    invert: disabled, glitch_filter: disabled, slew_rate: fast, open_drain: disabled}
  ...
  - {pin_num: A5, peripheral: EMC, signal: 'EMC_D, 4', pin_signal: PIO0_6/FC3_SCK/CTIMER3_CAP1/CTIMER4_MAT0/SCT0_GPI6/EMC_D(4)/ENET_RX_DV, identifier: EMC_D4, mode: inactive,
    invert: disabled, glitch_filter: disabled, slew_rate: fast, open_drain: disabled}
...
void BOARD_InitPins(void)
{
    ...
    IOCON->PIO[0][17] = ((IOCON->PIO[0][17] &
                         ...
                         /* Selects pin function.: PORT017 (pin E14) is configured as ENET_TXD1 */
    ...
    IOCON->PIO[2][26] = ((IOCON->PIO[2][26] &
                         ...
                         /* Selects pin function.: PORT226 (pin H11) is configured as PIO2_26 */
    ...
    IOCON->PIO[4][10] = ((IOCON->PIO[4][10] &
                         ...
                         /* Selects pin function.: PORT410 (pin B9) is configured as ENET_RX_DV */
    ...
    IOCON->PIO[4][11] = ((IOCON->PIO[4][11] &
                         ...
                         /* Selects pin function.: PORT411 (pin A9) is configured as ENET_RXD0 */
    ...
    IOCON->PIO[4][12] = ((IOCON->PIO[4][12] &
                         ...
                         /* Selects pin function.: PORT412 (pin A6) is configured as ENET_RXD1 */
    ...
    IOCON->PIO[4][13] = ((IOCON->PIO[4][13] &
                         ...
                         /* Selects pin function.: PORT413 (pin B6) is configured as ENET_TX_EN */
    ...
    IOCON->PIO[4][14] = ((IOCON->PIO[4][14] &
                         ...
                         /* Selects pin function.: PORT414 (pin B5) is configured as ENET_RX_CLK */
    ...
    IOCON->PIO[4][15] = ((IOCON->PIO[4][15] &
                         ...
                         /* Selects pin function.: PORT415 (pin A4) is configured as ENET_MDC */
    ...
    IOCON->PIO[4][16] = ((IOCON->PIO[4][16] &
                         ...
                         /* Selects pin function.: PORT416 (pin C4) is configured as ENET_MDIO */
    ...
    IOCON->PIO[4][8] = ((IOCON->PIO[4][8] &
                        ...
                        /* Selects pin function.: PORT48 (pin B14) is configured as ENET_TXD0 */
